...
local function show_group_settingsmod(msg, data, target)
  ...
  local text = "›🔥Group Settings🔥:\n✳locked groups : "..settings.lock_join.."\n○●○●○●\n⚙Locked group join : "..settings.lock_fosh.."\n○●○●○●\n⚙Lock group Fosh : "..settings.antichat.."\n○●○●○●\n⚙Lock group chat : "..settings.lock_ads.."\n○●○●○●\n⚙Lock group ads : "..settings.lock_china.."\n○●○●○●\n⚙Lock group china : "..settings.lock_name.."\n○●○●○●\n⚙Lock group name : "..settings.lock_photo.."\n○●○●○●\n⚙Lock group photo : "..settings.lock_member.."\n○●○●○●\n⚙kick new member : "..settings.leave_ban.."\n○●○●○●\n⚙Lock leave ban : "..settings.lock_emoji.."\n○●○●○●\n⚙Lock group emoji : "..settings.lock_share.."\n○●○●○●\n⚙Lock group share :  "..settings.lock_video.."\n○●○●○●\n⚙Lock group video :  "..settings.lock_audio.."\n○●○●○●\n⚙Lock group audio : "..settings.lock_ph.."\n○●○●○●\n⚙Lock group ph : "..settings.lock_media.."\n○●○●○●\n⚙Lock group media :  "..settings.lock_tag.."\n○●○●○●\n⚙Lock group tag : "..settings.lock_link.."\n○●○●○●\n⚙Lock group link : "..settings.lock_sticker.."\n○●○●○●\n⚙Lock group sticker : "..settings.lock_user.."\n○●○●○●\n⚙Lock group user : "..settings.lock_gif.."\n○●○●○●\n⚙Lock group gif : "..settings.lock_pars.."\n○●○●○●\n⚙Lock group pars : "..settings.lock_english.."\n○●○●○●\n⚙Lock group english : "..leave_ban.."\n○●○●○●\n⚙floodings spam : "..NUM_MSG_MAX.."\n•••Bot can come : "..bots_protection.."                                        ›»king bot♤ commands settings:helpsettings "
  return text
end
